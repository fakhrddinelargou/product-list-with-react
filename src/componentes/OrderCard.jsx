...
border-[#cbcbcb3a]"
          >
            ...
            <div className="flex gap-5">
              <span className="text-[var(--primary-color-red)] font-medium">
                {product.count}x
              </span>
              <span className="text-[var(--primary-color-rose-300)]">
                @ ${product.price.toFixed(2)}
              </span>
              <span className="text-[var(--primary-color-rose-400)]">
      ...
      {grandTotal > 0 ? (
        <div>
          ...
          <div>
            <p className="text-xl flex gap-3 bg-[var(--primary-color-rose-100)] p-[1rem] rounded-[.4rem] items-center justify-center text-[var(--primary-color-rose-500)]">
